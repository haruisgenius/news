...
public class NewsTest {
	...
	public void createNewsTest() {
		...
		NewsResponse res4 = nService.createNews("test3", "test1", LocalDate.of(2023, 11, 12), "jjjjj", "test3 test3 test3");
	...
	public void updateNewsTest() {
		...
		System.out.println(res7.getMessage());
		NewsResponse res8 = nService.updateNews(1, "update1", "update", LocalDate.now(), "a11", "update1 update1");
		System.out.println(res8.getMessage());
		NewsResponse res9 = nService.updateNews(2, "update2", "update2", LocalDate.of(2023, 11, 27), "ss8", "update");
